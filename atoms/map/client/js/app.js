...
const manageMove = (event, d) => {
	...
	let message = country == 'Ireland' ? `Ireland is part of the common travel area` :`<span class=map-${d.status}>${country}</span> ${verb} on the <span class=map-${d.status}>${d.status}</span> list`
